                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="controlador.php" method="POST">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" name="nombre" required/>
                                            ...
                                            <?php
                                                    if (isset($_GET['error'])) {
                                                        echo "<h5 class='text-danger'>Las contraseñas no coinciden</h5>";
                                                    }
