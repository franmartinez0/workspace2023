...
<?php
 ...
 define('DB_HOST', 'database-php.cj1wbbjnneg8.us-east-1.rds.amazonaws.com'); //La IP del contenedor Mysql, y el puerto interno del contenedor , no tiene nada que ver con el puerto que toma el contenedor para conectarse al exterior
